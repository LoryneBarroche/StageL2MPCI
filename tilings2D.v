...
Proof.
  ...
  - intros. apply Neighbour_none.
  pose (b:= (z1 =z= Z.pred z)).
  assert ((z1 =z= Z.pred z) = b) by reflexivity.
  destruct b. apply Z.eqb_eq in H. destruct H. apply Z.eqb_neq. unfold Z.eqb. Admitted. 
